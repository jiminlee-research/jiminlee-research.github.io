...
.about-page .about-hero h1 { color: #8b1e1e; font-size: 2.6rem; margin: 0 0 .6rem; }
.about-page .about-hero p { color: #5f6368; font-size: 1.2rem; margin: 0; }
.about-page .about-section { margin: 3rem 0; }
.about-page .about-section h2 { color: #8b1e1e; font-size: 1.8rem; border-bottom: 2px solid #e5e7eb; padding-bottom: .6rem; }
  ...
  <section class="about-section">
    ...
    <div class="interest-grid">
      <article class="interest-card">
        <span class="label">MENTAL HEALTH EQUITY</span>
